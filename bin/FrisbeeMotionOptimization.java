...
public class FrisbeeMotionOptimization
{
    ///////////////////////////////////////////////////////////////////////////////////////////////
    // Declare constants
    ///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    */	
    ...
    {
		double accy = ((dragforceY(angleOfAttack, beta, vx, vy) + liftforceY(angleOfAttack, beta, vx, vy))/mass) - gravity; 
        return accy;
    }	
    ...
    */	
	...
	{
		double accx = (dragforceX(angleOfAttack, beta, vx, vy) + liftforceX(angleOfAttack, beta, vx, vy))/mass;   //Equation to find the acceleration in x direction
        return accx;
	}
